...
- **ajv/ajv-keywords conflicts**: Added overrides to force compatible versions:
  - `ajv@^6.12.6`
  - `ajv-keywords@^3.5.2`
...
The build should now work on Vercel with `--legacy-peer-deps` flag which allows npm to install packages despite peer dependency conflicts.
